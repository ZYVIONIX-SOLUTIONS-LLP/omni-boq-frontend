...
const TABS = [
  { label: "Product Library", href: "/Materials", exact: true },
  { label: "Manufacturers", href: "/Materials/manufacturers" },
  { label: "Series", href: "/Materials/series" },
  { label: "Categories", href: "/Materials/categories" },
  { label: "Units & Tax", href: "/Materials/settings" },
];
        ...
        <nav className="flex items-center gap-1 overflow-x-auto py-2">
          {TABS.map((tab) => {
            ...
            const isActive = tab.exact
              ? pathname === tab.href || pathname.startsWith("/Materials/new")
